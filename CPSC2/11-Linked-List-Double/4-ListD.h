...
class ListD
{
 ...
 private:
   ...
   */
   doubleNode<D>* FindPosition(int pos);

   int length;         //length of the list
   doubleNode<D>* head;   //points to the first dummy node 
   doubleNode<D>* tail;   //points to the last dummy node  
};
#endif
